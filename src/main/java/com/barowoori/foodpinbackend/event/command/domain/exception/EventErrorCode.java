...
public enum EventErrorCode implements ErrorCode {
    ...
    ALREADY_IN_PROGRESS_EVENT(HttpStatus.BAD_REQUEST, 40023, "ALREADY_IN_PROGRESS_EVENT"),
    NO_APPLICABLE_TRUCKS(HttpStatus.BAD_REQUEST, 40024, "NO_APPLICABLE_TRUCKS"),
    CONFIRMED_EVENT_TRUCK_EXISTS(HttpStatus.BAD_REQUEST, 40025, "CONFIRMED_EVENT_TRUCK_EXISTS"),
    NOT_IN_PROGRESS_EVENT(HttpStatus.BAD_REQUEST, 40026, "NOT_IN_PROGRESS_EVENT"),
    EVENT_CONTACT_ACCESS_DENIED(HttpStatus.BAD_REQUEST, 40027, "EVENT_CONTACT_ACCESS_DENIED"),
    SELECTED_EVENT_APPLICATION_EXISTS(HttpStatus.BAD_REQUEST, 40028, "SELECTED_EVENT_APPLICATION_EXISTS");
