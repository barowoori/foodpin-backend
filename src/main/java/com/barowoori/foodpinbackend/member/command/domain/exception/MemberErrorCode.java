...
public enum MemberErrorCode implements ErrorCode {
    ...
    SOCIAL_LOGIN_DATA_PARSING_ERROR(HttpStatus.BAD_REQUEST, 20014, "SOCIAL_LOGIN_DATA_PARSING_ERROR"),
    MEMBER_NOT_ADMIN(HttpStatus.FORBIDDEN, 20015, "MEMBER_NOT_ADMIN");
