...
@Getter
public class OwnerUpdatedNotificationEvent extends NotificationEvent {
    private final String truckId;
    private final String truckName;
    private final String nickname;

    public OwnerUpdatedNotificationEvent(String truckId, String truckName, String nickname) {
        super();
