...
public interface NotificationService {
    void pushAlarmToToken(NotificationType type, String title, String content, String token, NotificationTargetType targetType, String targetId, Map<String, Object> params);
}
