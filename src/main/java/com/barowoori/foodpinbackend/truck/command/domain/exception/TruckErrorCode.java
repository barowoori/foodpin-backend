...
public enum TruckErrorCode implements ErrorCode {
    ...
    TRUCK_MANAGER_LIMIT_EXCEEDED(HttpStatus.BAD_REQUEST, 30011, "TRUCK_MANAGER_LIMIT_EXCEEDED"),
    TRUCK_ALREADY_IN_PROGRESS_EVENT(HttpStatus.BAD_REQUEST, 30012, "TRUCK_ALREADY_IN_PROGRESS_EVENT"),
    TRUCK_CONTACT_ACCESS_DENIED(HttpStatus.FORBIDDEN, 30013, "TRUCK_CONTACT_ACCESS_DENIED"),
    TRUCK_DOCUMENT_NOT_FOUND(HttpStatus.NOT_FOUND, 30014, "TRUCK_DOCUMENT_NOT_FOUND"),
    TRUCK_UPDATE_NOT_AVAILABLE(HttpStatus.BAD_REQUEST, 30015, "TRUCK_UPDATE_NOT_AVAILABLE");
