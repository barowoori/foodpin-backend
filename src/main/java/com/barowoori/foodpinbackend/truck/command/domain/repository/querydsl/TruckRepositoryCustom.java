...
public interface TruckRepositoryCustom {
    ...
    Page<TruckProjection> findTruckListByFilter(String searchTerm, List<String> categoryCodes, Map<RegionType, List<String>> regionIds,
                                                ...
                                                Pageable pageable);
    Page<TruckProjection> findLikeTruckListByFilter(String memberId, String searchTerm, List<String> categoryCodes, Map<RegionType, List<String>> regionIds,
                                                    Set<TruckType> types, Integer minAvgMenuPrice, Integer maxAvgMenuPrice, Set<TruckColor> colors, Set<TruckBodyType> bodyTypes,
                                                    Set<PaymentMethod> paymentMethods, Set<ProofIssuanceType> proofIssuanceTypes, Boolean isCatering,
                                                    Pageable pageable);
    Page<TruckProjection> findBackOfficeTruckListByFilter(String searchTerm, List<String> categoryCodes, Map<RegionType, List<String>> regionIds,
                                                          Set<TruckType> types, Integer minAvgMenuPrice, Integer maxAvgMenuPrice, Set<TruckColor> colors, Set<TruckBodyType> bodyTypes,
