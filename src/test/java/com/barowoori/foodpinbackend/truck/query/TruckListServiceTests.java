...
public class TruckListServiceTests {
    ...
    class When_Exist_SearchTerm {
        ...
        void When_TruckNameContainSearchTerm() {
            ...
            Page<TruckList> result = truckListService.findTruckList(null, null, searchTerm,null,null,null,null,null,null,null, null, pageable);
    ...
    class Filtering {
        ...
        void When_NotFilter_Then_GetAllTruckList() {
            Pageable pageable = PageRequest.of(0, 10, Sort.by(Sort.Direction.DESC, "createdAt"));
            assertThat(truckListService.findTruckList(null, null, null,null,null,null,null,null,null,null, null, pageable).get().noneMatch(truck -> truck.getId().equals(deletedTruck)));
        }
        ...
        void When_CategoryFiltering() {
            Pageable pageable = PageRequest.of(0, 10, Sort.by(Sort.Direction.DESC, "createdAt"));
            Page<TruckList> result = truckListService.findTruckList(null, List.of("C01"), null,null,null,null,null,null,null,null, null, pageable);
        ...
        void When_NotExistCategoryFiltering() {
            Pageable pageable = PageRequest.of(0, 10, Sort.by(Sort.Direction.DESC, "createdAt"));
            Page<TruckList> result = truckListService.findTruckList(null, List.of("C02"), null,null,null,null,null,null,null,null, null, pageable);
        ...
        void When_RegionFiltering() {
            Pageable pageable = PageRequest.of(0, 10, Sort.by(Sort.Direction.DESC, "createdAt"));
            Page<TruckList> result = truckListService.findTruckList(List.of("SI" + yongIn.getId()), null, null,null,null,null,null,null,null,null,null, pageable);
            assertEquals(1, result.getNumberOfElements());
        }
        ...
        void When_RegionFiltering_DO() {
            Pageable pageable = PageRequest.of(0, 10, Sort.by(Sort.Direction.DESC, "createdAt"));
            Page<TruckList> result = truckListService.findTruckList(List.of("DO" + yongIn.getRegionDo().getId()), null, null,null,null,null,null,null,null,null,null, pageable);
            assertEquals(1, result.getNumberOfElements());
        }
        ...
        void When_NotExistRegionFiltering_SI() {
            Pageable pageable = PageRequest.of(0, 10, Sort.by(Sort.Direction.DESC, "createdAt"));
            Page<TruckList> result = truckListService.findTruckList(List.of("SI" + anyang.getId()), null, null,null,null,null,null,null,null,null,null, pageable);
            assertEquals(0, result.getNumberOfElements());
        }
    }
